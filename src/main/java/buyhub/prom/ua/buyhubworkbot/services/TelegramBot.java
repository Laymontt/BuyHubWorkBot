    ...
    public void onUpdateReceived(Update update) {
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            if (message.startsWith("/start") && message.length() == 6)
                ...
                sendMessage(chatId, "Пока не добавлено ни одного гайда");
    ...
    private void helpCommandReceived(long chatId) {
        sendMessage(chatId,
                """
                        ...
                        /tags [список тегов] - на вход команде дается скопированный список тегов из карточки на проме (манипуляций с тегами не должно проводиться никаких), а на выходе получаем преобразованный к нужному виду список тегов, который можно сразу же вставлять в карточку.
                        ----------------------------------------------------------------------------------------------------
